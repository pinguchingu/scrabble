...
build/scrabble.o: scrabble.cpp scrabble.h build/.make exceptions.h board.h tile_bag.h dictionary.h human_player.h computer_player.h scrabble_config.h move.h colors.h
	$(COMPILE) -c $< -o $@
